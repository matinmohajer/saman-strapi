...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    backrest_height: Schema.Attribute.Integer &
    ...
    imaages: Schema.Attribute.Media<'images' | 'files', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    product_code: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    seat_material: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiStoryStory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    hero_image_mobile: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    story: Schema.Attribute.Component<'shared.story', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    story_id: Schema.Attribute.UID &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    story_name: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
